...
const colorContainer = document.querySelector('#css-color-names');
for (let color of colors) {
   colorContainer.style = 'line-height: 1; margin-bottom: 1em;';
   colorContainer.insertAdjacentHTML('beforeend', `
      <div class="css-color-box" style="display: inline-block; width: 1.5em; height: 1.5em; border-radius: 0.1em; margin: 0.1em; background-color: ${color.hex}; border: 1px solid #00000010;" title="${color.name}"></div>
   `);
}
Array.from(document.querySelectorAll('.css-color-box')).forEach(colorBox => {
